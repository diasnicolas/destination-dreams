        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-primary font-display italic">
              É uma conversa com 5.000 anos de história.
            </p>
          </div>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              <strong className="text-foreground"> Com conhecimento. Com crescimento. Com transformação.</strong>
            </p>
            <p>
              Você viveu experiências que poucas pessoas vivem. 
              Você tocou a Grande Muralha da China.
              Você viu os Guerreiros de Terracota construídos há 2.200 anos.
              Você tocou os pandas gigantes em Chengdu.
              Você caminhou em Zhangjiajie, onde Avatar foi inspirado.
              Você viu Shanghai, o futuro da China.
            </p>
            <p>
          ...
          <p className="text-lg text-foreground font-semibold">
            Você é um dos <span className="text-primary">eleitos</span> para explorar as maravilhas culturais da China.
          </p>

          {/* Signature */}
          <div className="pt-8 border-t border-turquoise/20">
            <p className="text-primary font-display italic text-lg mb-2">
              Bem-vindo à jornada pelo Oriente milenar.
            </p>
