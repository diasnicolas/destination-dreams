...
import photo1601581875039 from "@/assets/grecia/photo-1601581875039-e899893d520c.jpg";
import photo1580502304784 from "@/assets/grecia/photo-1580502304784-8985b7eb7260.jpg";
import photo1586861203927 from "@/assets/grecia/photo-1586861203927-800a5acdcc4d.jpg";

const galleryImages = [
  { 
    src: photo1613395877344, 
    title: "Acrópole de Atenas", 
    category: "Atenas" 
  },
  { 
    src: photo1570077188670, 
    title: "Navagio Beach", 
    category: "Zakynthos" 
  },
  { 
    src: photo1533105079780, 
    title: "Pôr do Sol em Oia", 
    category: "Santorini" 
  },
  { 
    src: photo1555993539, 
    title: "Moinhos de Mykonos", 
    category: "Mykonos" 
  },
  { 
    src: photo1504512485720, 
    title: "Blue Caves", 
    category: "Zakynthos" 
  },
  { 
  ...
  { 
    src: photo1601581875039, 
    title: "Little Venice", 
    category: "Mykonos" 
  },
  { 
    src: photo1580502304784, 
    title: "Caldeira Vulcânica", 
    category: "Santorini" 
  },
  { 
    src: photo1586861203927, 
    title: "Bairro de Plaka", 
    category: "Atenas" 
  },
];

export const PhotoGalleryGR = () => {
      ...
      <div className="w-full px-4 md:px-8 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Clique nas imagens para explorar a beleza das ilhas gregas
          </p>
        </motion.div>
