        ...
        >
          ...
          <div className="space-y-4">
            <h3 className="font-display text-2xl md:text-3xl font-bold text-foreground">
              A Grécia não é apenas uma viagem.
            </h3>
            <p className="text-xl text-primary font-display italic">
              É uma jornada através da história, beleza e alma do Mediterrâneo.
            </p>
          </div>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              <strong className="text-foreground"> Encantado. Transformado.</strong>
            </p>
            <p>
              Você viveu experiências que poucas pessoas vivem. 
              Você pisou onde os deuses do Olimpo foram adorados.
              Você nadou nas águas mais azuis do mundo em Navagio Beach.
              Você assistiu ao pôr do sol mais famoso do planeta em Santorini.
            </p>
            <p>
              Você descobriu a Grécia além do óbvio — Zakynthos, Cephalonia, Mykonos.
              Ilhas que guardam segredos que poucos conhecem.
            </p>
            <p>
          ...
          <p className="text-lg text-foreground font-semibold">
            Você merece <span className="text-primary">descobrir a Grécia autêntica</span>.
          </p>

          {/* Signature */}
          <div className="pt-8 border-t border-turquoise/20">
            <p className="text-primary font-display italic text-lg mb-2">
              Grécia Além do Óbvio.
            </p>
            <p className="text-foreground font-medium mb-1">
              Sua jornada pelo Mediterrâneo começa agora.
            </p>
