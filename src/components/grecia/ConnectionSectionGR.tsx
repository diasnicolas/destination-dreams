...
const credentials = [
  {
    icon: Award,
    text: "Especialista em Grécia — Conhecimento profundo das ilhas gregas e sua cultura",
  },
  {
    icon: MapPin,
    text: "Roteiros testados pessoalmente — Cada ilha, cada hotel, cada taverna foi vivenciada",
  },
  {
    icon: Users,
...
const certifications = [
  {
    ...
    description: "Certificação oficial para especialistas em turismo",
...
export const ConnectionSectionGR = () => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              <span className="text-foreground">Sua Grécia é </span>
            ...
            <div className="space-y-4 mb-8 text-muted-foreground">
              ...
              <p className="text-lg leading-relaxed">
                Este roteiro pela Grécia foi <strong className="text-foreground">pessoalmente criado e testado</strong>.
                Cada ilha, cada hotel boutique, cada pôr do sol em Santorini foi vivenciado antes de ser oferecido a você.
              </p>
              <p className="text-lg leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              {certifications.map((cert, index) => {
                const CardContent = (
                  <>
                    <cert.icon className="w-6 h-6 text-primary mb-2" />
                ...
                return cert.href ? (
                  <motion.a
                    ...
                    className="glass-card p-4 rounded-lg border border-primary/20 cursor-pointer hover:scale-105 transition-transform"
                  >
                    {CardContent}
                  </motion.a>
                ) : (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.5, delay: 0.4 + index * 0.1 }}
                    className="glass-card p-4 rounded-lg border border-primary/20"
                  >
                    {CardContent}
                  </motion.div>
                );
