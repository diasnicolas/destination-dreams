...
import imgMontanhas from "@/assets/ushuaia-calafate/photo-1518457607834-6e8d80c183c5.jpg";
import imgBuenosAires from "@/assets/ushuaia-calafate/photo-1577587230708-187fdbef4d91.jpg";

const galleryImages = [
  { src: imgGlaciar, title: "Glaciar Perito Moreno", category: "El Calafate" },
  { src: imgGlaciar, title: "Paisagem Patagônia", category: "Patagônia" },
  { src: imgUshuaia, title: "Pinguins Magalhães", category: "Canal Beagle" },
  { src: imgUshuaia, title: "Ushuaia", category: "Fim do Mundo" },
  { src: imgMontanhas, title: "Montanhas Nevadas", category: "Patagônia" },
  { src: imgBuenosAires, title: "Buenos Aires", category: "Argentina" },
];

export const PhotoGalleryUC = () => {
