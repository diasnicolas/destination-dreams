        ...
        >
          ...
          <div className="space-y-4">
            <h3 className="font-display text-2xl md:text-3xl font-bold text-foreground">
              O Fim do Mundo não é apenas uma viagem.
            </h3>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              Você esteve no ponto mais austral do mundo.
              Você ouviu o estrondo das geleiras milenares.
              Você navegou entre pinguins e leões marinhos no Canal Beagle.
              Você caminhou sobre o Perito Moreno.
            </p>
            <p>
          ...
          <div className="pt-8 border-t border-turquoise/20">
            ...
            <div className="text-sm text-muted-foreground space-y-1 mt-2">
              ...
              <p>Especialista em América do Sul</p>
