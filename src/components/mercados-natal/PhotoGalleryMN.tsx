...
import imgVila from "@/assets/mercados-natal/photo-1576919228236-a097c32a5cd4.jpg";
import imgLago from "@/assets/mercados-natal/photo-1548777123-e216912df7d8.jpg";

const galleryImages = [
  { src: imgColmar, title: "Mercado de Natal", category: "Estrasburgo" },
  { src: imgColmar, title: "Pequena Veneza", category: "Colmar" },
  { src: imgAlpes, title: "Alpes Nevados", category: "Suíça" },
  { src: imgDecoracoes, title: "Decorações Natalinas", category: "Mercados" },
  { src: imgVila, title: "Vila Medieval", category: "Alsácia" },
  { src: imgLago, title: "Lago Léman", category: "Montreux" },
];

export const PhotoGalleryMN = () => {
