      ...
      <div className="container px-4 md:px-8 lg:px-12">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold">
            Você Está Pronto Para Descobrir os <span className="text-primary">Segredos Reais e Encantos Eternos</span>?
          </h2>

          {/* Countdown Timer */}
          <div className="py-6">
            <p className="text-center text-sm text-muted-foreground uppercase tracking-widest mb-4">
              Embarque em 13 de Maio de 2026
            </p>
            <CountdownTimer targetDate="2026-05-13T00:00:00" />
          </div>
          ...
          <div className="space-y-4 text-xl">
            ...
            <p className="font-semibold text-foreground">Você quer descobrir os segredos reais do Reino Unido?</p>
          ...
          >
            QUERO DESCOBRIR OS SEGREDOS REAIS - AGENDAR CONSULTA
          </Button>
