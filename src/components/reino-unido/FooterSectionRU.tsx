        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-primary font-display italic">
              É uma descoberta dos segredos reais e encantos eternos.
            </p>
          </div>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              Você dormiu 6 noites ao lado do Big Ben.
              Você caminhou pelas ruas medievais de Durham.
              Você explorou o Castelo de Edinburgh com uma historiadora.
              Você descobriu as Highlands de Inverness.
              Você conheceu Liverpool, a cidade da música.
              Você relaxou em Bath, a cidade romana.
            </p>
            <p>
          ...
          <p className="text-lg text-foreground font-semibold">
            Você é um dos <span className="text-primary">eleitos</span> para descobrir os segredos reais do Reino Unido.
          </p>

          {/* Signature */}
          <div className="pt-8 border-t border-turquoise/20">
            <p className="text-primary font-display italic text-lg mb-2">
              Bem-vindo à jornada pelo Reino Unido.
            </p>
            ...
            <div className="text-sm text-muted-foreground space-y-1 mt-2">
              ...
              <p>8 anos vivendo em Londres — Expertise britânica</p>
