        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-primary font-display italic">
              É uma transformação entre a savana e o paraíso.
            </p>
          </div>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              Você esteve frente a frente com os Big Five.
              Você viu leões, leopardos, rinocerontes, elefantes e búfalos na natureza selvagem.
              Você interagiu com Jessica a Hipopótamo.
              Você relaxou em praias paradisíacas nas Ilhas Maurício.
            </p>
            <p>
          ...
          <p className="text-lg text-foreground font-semibold">
            Você é um dos <span className="text-primary">eleitos</span> para viver a emoção do safári africano.
          </p>

          {/* Signature */}
          <div className="pt-8 border-t border-turquoise/20">
            <p className="text-primary font-display italic text-lg mb-2">
              Bem-vindo à jornada entre a savana e o paraíso.
            </p>
