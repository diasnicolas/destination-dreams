...
const credentials = [
  {
    icon: Award,
    text: "Especialista em África — Conhecimento profundo dos melhores safáris e experiências",
  },
  {
    icon: MapPin,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            <div className="relative">
              ...
              >
                <span className="text-xs font-semibold text-primary">Especialista em África</span>
              </motion.div>
          ...
          >
            ...
            <div className="space-y-4 mb-8 text-muted-foreground">
              ...
              <p className="text-lg leading-relaxed">
                Este roteiro pela África do Sul e Ilhas Maurício foi <strong className="text-foreground">pessoalmente criado e testado</strong>.
                Cada safári, cada vinícola, cada praia paradisíaca foi vivenciada antes de ser oferecida a você.
              </p>
              <p className="text-lg leading-relaxed">
