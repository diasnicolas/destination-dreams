...
const included = ["Voos internacionais (Brasil > África do Sul > Maurício > Brasil)", "Voo privado Johannesburg → Kruger", "Voo direto Kruger → Cape Town", "Hospedagens nos melhores hotéis 4-5 estrelas", "Todos os transfers privados", "3 safáris inclusos (manhã e tarde)", "Piscina em cada quarto no Kruger", "Jantares todas as noites no Kruger", "Passeios inclusos em Cape Town", "1 noite em Stellenbosch (vinícolas)", "4 noites Maurício All Inclusive", "Guias locais especializados", "Acompanhamento desde o Brasil (24/7)", "Seguro viagem completo", "App exclusivo com detalhes da viagem", "Grupo no WhatsApp"];
const notIncluded = ["Bebidas alcoólicas (exceto em Maurício All Inclusive)", "Atividades opcionais", "Gorjetas (opcional)", "Despesas pessoais"];

export const InclusionsSectionAM = () => {
  return (
