...
const faqs = [
  { question: "Preciso de visto para o Japão?", answer: "Não precisa de visto para o Japão! Brasileiros podem entrar com passaporte válido por até 90 dias. Muito fácil!" },
  { question: "Preciso de visto para a China?", answer: "Sim, você precisa de visto para a China. Mas não se preocupe! Nós cuidamos de tudo e vamos te orientar em cada passo do processo." },
  ...
  { question: "A viagem é segura?", answer: "Sim! Japão e China são países muito seguros para turistas. Além disso, você terá guias locais especializados, suporte 24/7 e seguro viagem completo." },
];

export const FAQSectionJC = () => {
  return (
