...
const highlights = [
  {
    icon: Calendar,
    title: "20 dias de transformação",
    description: "03 a 22 de Abril de 2026",
  },
  {
    icon: User,
  ...
  {
    icon: Globe,
    title: "7 cidades icônicas",
    description: "Kyoto → Toyama → Fujikawaguchiko → Tóquio → Beijing → Hangzhou → Xangai",
  },
  {
    icon: Sparkles,
    title: "Experiências exclusivas",
    description: "Monte Fuji, Grande Muralha, templos milenares",
  },
];

export const HeroSectionJC = () => {
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-body tracking-wide text-primary">
              03 de Abril de 2026 • 20 dias de transformação
            </span>
          </motion.div>
          ...
          >
            ...
            <br />
            <span className="text-gradient-gold">Viajar Entre Dois Mundos?</span>
          </motion.h1>
          ...
          >
            Uma jornada de 20 dias pelo Japão e China que vai despertar todos os seus sentidos
          </motion.p>
