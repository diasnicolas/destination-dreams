...
const credentials = [
  {
    icon: Award,
    text: "Especialista em Ásia — Conhecimento profundo da cultura japonesa e chinesa",
  },
  {
    icon: MapPin,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4 mb-8 text-muted-foreground">
              ...
              <p className="text-lg leading-relaxed">
                Este roteiro pelo Japão e China foi <strong className="text-foreground">pessoalmente criado e testado</strong>.
                Cada templo, cada paisagem, cada experiência cultural foi vivenciada antes de ser oferecida a você.
              </p>
              <p className="text-lg leading-relaxed">
