        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-primary font-display italic">
              É uma travessia entre dois mundos.
            </p>
          </div>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              Você esteve em templos milenares do Japão.
              Você viu o Monte Fuji ao amanhecer.
              Você caminhou pela Grande Muralha da China.
              Você visitou a Cidade Proibida.
              Você viveu a energia de Tóquio e a modernidade de Xangai.
            </p>
            <p>
          ...
          <p className="text-lg text-foreground font-semibold">
            Você é um dos <span className="text-primary">eleitos</span> para viajar entre dois mundos.
          </p>

          {/* Signature */}
          <div className="pt-8 border-t border-turquoise/20">
            <p className="text-primary font-display italic text-lg mb-2">
              Bem-vindo à jornada entre Japão e China.
            </p>
