...
const included = ["Voos internacionais Qatar Airways", "Hospedagens em hotéis 4-5 estrelas", "Ryokan tradicional com vista para Monte Fuji", "Todos os transfers privados", "Trem-bala Shinkansen no Japão", "Todos os passeios inclusos", "Guias locais especializados", "Acompanhamento desde o Brasil (24/7)", "Seguro viagem completo", "App exclusivo com detalhes da viagem", "Grupo no WhatsApp"];
...
export const InclusionsSectionJC = () => {
  return (
