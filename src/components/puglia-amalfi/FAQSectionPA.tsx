...
const faqs = [
  { question: "Preciso de visto para a Itália?", answer: "Não precisa de visto para a Itália! Brasileiros podem entrar no Espaço Schengen com passaporte válido por até 90 dias. Muito fácil!" },
  ...
  { question: "A viagem inclui passeio de barco?", answer: "Sim! Inclui passeio de barco até a ilha de Capri com visita à famosa Gruta Azul (sujeito a condições climáticas)." },
  { question: "Qual a melhor época para a Costa Amalfitana?", answer: "Junho é perfeito! Clima agradável, sol, sem as multidões do verão europeu. Ideal para aproveitar praias e passeios." },
];

export const FAQSectionPA = () => {
  return (
