...
const included = ["Voos internacionais (Brasil > Itália > Brasil)", "Hospedagens em hotéis 4-5 estrelas", "Hotéis com vista para o mar", "Todos os transfers privados", "Passeios inclusos (Alberobello, Matera, Lecce)", "Passeios Costa Amalfitana (Positano, Amalfi, Ravello)", "Passeio de barco a Capri", "Guias locais especializados", "Acompanhamento desde o Brasil (24/7)", "Seguro viagem completo", "App exclusivo com detalhes da viagem", "Grupo no WhatsApp"];
const notIncluded = ["Refeições não mencionadas", "Bebidas alcoólicas", "Atividades opcionais", "Gorjetas (opcional)", "Despesas pessoais"];

export const InclusionsSectionPA = () => {
  return (
