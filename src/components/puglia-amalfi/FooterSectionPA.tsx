        ...
        >
          ...
          <div className="space-y-4">
            <h3 className="font-display text-2xl md:text-3xl font-bold text-foreground">
              Este roteiro não é apenas uma viagem.
            </h3>
            <p className="text-xl text-primary font-display italic">
              É a Itália autêntica que você sempre sonhou.
            </p>
          </div>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              Você caminhou pelas ruas de Puglia.
              Você viu o pôr do sol em Polignano a Mare.
              Você explorou os trulli de Alberobello.
              Você descobriu as cavernas de Matera.
              Você se encantou com a Costa Amalfitana.
              Você navegou até Capri e viu a Gruta Azul.
            </p>
            <p>
          ...
          <p className="text-lg text-foreground font-semibold">
            Você é um dos <span className="text-primary">eleitos</span> para viver a Itália dos sonhos.
          </p>

          {/* Signature */}
          <div className="pt-8 border-t border-turquoise/20">
            <p className="text-primary font-display italic text-lg mb-2">
              Bem-vindo à jornada pela Puglia e Costa Amalfitana.
            </p>
