...
const highlights = [
  {
    icon: Calendar,
    title: "18 dias de transformação",
    description: "Uma jornada completa pela Oceania",
  },
  {
    icon: User,
    title: "Acompanhamento pessoal",
    description: "Evandro Mendes (3 anos em Sydney)",
  },
  {
    icon: Globe,
    title: "6 cidades icônicas",
    description: "Sydney → Cairns → Melbourne → Queenstown → Rotorua → Auckland",
  },
  {
    icon: Sparkles,
    title: "Experiências exclusivas",
    description: "Barreira de Corais, Hobbiton, Milford Sound",
  },
];

export const HeroSectionAUNZ = () => {
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-body tracking-wide text-primary">
              18 dias • 6 cidades • 1 transformação profunda
            </span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl lg:text-2xl text-primary font-light tracking-wide mb-6 max-w-3xl mx-auto"
          >
            Uma jornada de 18 dias pela Austrália & Nova Zelândia que vai transformar a forma como você vê o mundo
          </motion.p>
          ...
          <motion.div
            ...
            className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto mb-12 space-y-2"
          >
            <p>Existe um momento na vida em que você percebe que precisa de mais.</p>
            <p className="text-foreground font-medium">Austrália & Nova Zelândia é assim.</p>
          </motion.div>
