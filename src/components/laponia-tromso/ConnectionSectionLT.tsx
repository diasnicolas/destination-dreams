...
const credentials = [
  {
    icon: Award,
    text: "Especialista em Ártico — Conhecimento profundo da Lapônia e Noruega",
  },
  {
    icon: MapPin,
    text: "Roteiros testados pessoalmente — Cada hotel, cada aurora, cada detalhe foi vivenciado",
  },
  {
    icon: Users,
...
export const ConnectionSectionLT = () => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              <span className="text-foreground">Sua aurora é </span>
            ...
            <div className="space-y-4 mb-8 text-muted-foreground">
              ...
              <p className="text-lg leading-relaxed">
                Este roteiro pelo Ártico foi <strong className="text-foreground">pessoalmente criado e testado</strong>.
                Cada hotel, cada experiência de aurora boreal, cada detalhe foi vivenciado antes de ser oferecido a você.
              </p>
              <p className="text-lg leading-relaxed">
