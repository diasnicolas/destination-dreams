...
const galleryImages = [
  { src: imgAurora, title: "Aurora Boreal", category: "Lapônia" },
  { src: imgHuskies, title: "Huskies Siberianos", category: "Safari" },
  { src: imgAurora, title: "Hotel de Gelo", category: "Levi" },
  { src: imgPaisagem, title: "Paisagem Ártica", category: "Finlândia" },
  { src: imgPaisagem, title: "Fiordes Noruegueses", category: "Tromsø" },
  { src: imgPaisagem, title: "Helsinque", category: "Finlândia" },
];

export const PhotoGalleryLT = () => {
      ...
      <div className="w-full px-4 md:px-8 lg:px-12 relative z-10">
        ...
        >
          <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-bold mb-4">
            <span className="text-foreground">Galeria do </span>
            <span className="text-gradient-gold">Ártico</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Clique nas imagens para explorar a magia do Norte
          </p>
        </motion.div>
