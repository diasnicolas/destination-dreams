        ...
        >
          ...
          <div className="space-y-4">
            <h3 className="font-display text-2xl md:text-3xl font-bold text-foreground">
              O Ártico não é apenas uma viagem.
            </h3>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              Você viu a Aurora Boreal dançar no céu.
              Você dormiu em um iglu de gelo sob as estrelas.
              Você correu em um trenó puxado por huskies.
              Você cruzou o Círculo Polar Ártico.
            </p>
            <p>
