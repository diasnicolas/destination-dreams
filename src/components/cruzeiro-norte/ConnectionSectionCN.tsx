...
const credentials = [
  {
    icon: Award,
    text: "Especialista em Cruzeiros Premium — Conhecimento profundo de rotas e navios",
  },
  {
    icon: MapPin,
    text: "Roteiros testados pessoalmente — Cada porto foi visitado antes de ser oferecido",
  },
  {
    icon: Users,
...
export const ConnectionSectionCN = () => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4 mb-8 text-muted-foreground">
              ...
              <p className="text-lg leading-relaxed">
                Este roteiro pelo Norte da Europa foi <strong className="text-foreground">pessoalmente navegado e testado</strong>.
                Cada porto, cada fjord, cada experiência foi vivenciada antes de ser oferecida a você.
              </p>
              <p className="text-lg leading-relaxed">
