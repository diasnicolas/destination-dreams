...
const highlights = [
  {
    icon: Calendar,
    title: "Uma única saída em 2027",
    description: "Apenas 10 cabines, 20 viajantes",
  },
  {
    icon: User,
  ...
  {
    icon: Globe,
    title: "Destinos icônicos",
    description: "Sydney → Cruzeiro → Honolulu → Los Angeles",
  },
  {
    icon: Sparkles,
    title: "Experiências exclusivas",
    description: "Cangurus, golfinhos, Polinésia Francesa",
  },
];
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-body tracking-wide text-primary">
              8 de Abril de 2027 • 27 dias de transformação
            </span>
          </motion.div>
          ...
          >
            <span className="text-foreground">Existem viagens.</span>
            <br />
            <span className="text-gradient-gold">E existem <em>legados</em>.</span>
          </motion.h1>
          ...
          >
            Uma jornada de 27 dias que redefine o conceito de viagem premium
          </motion.p>
