...
const galleryImages = [
  ...
  { src: sydneyImage, title: "Sydney Opera House", category: "Sydney" },
  { src: kangaroosImage, title: "Cangurus em Jervis Bay", category: "Experiências" },
  { src: dolphinsImage, title: "Avistamento de Golfinhos", category: "Experiências" },
  { src: wineryImage, title: "Vinícola Boutique", category: "Gastronomia" },
  { src: polynesiaImage, title: "Polinésia Francesa", category: "Cruzeiro" },
  { src: honoluluImage, title: "Honolulu & Diamond Head", category: "Havaí" },
  { src: hollywoodImage, title: "Hollywood & Beverly Hills", category: "Los Angeles" },
];
      ...
      <AnimatePresence>
        {selectedIndex !== null && (
          ...
          >
            ...
            <button
              onClick={closeLightbox}
              className="absolute top-4 right-4 w-12 h-12 rounded-full bg-muted/50 flex items-center justify-center hover:bg-muted transition-colors z-10"
            >
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-muted/50 flex items-center justify-center hover:bg-muted transition-colors z-10"
            >
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-muted/50 flex items-center justify-center hover:bg-muted transition-colors z-10"
            >
