      ...
      <div className="container px-4 md:px-8 lg:px-12">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="max-w-4xl mx-auto space-y-6 text-lg text-muted-foreground text-center">
          ...
          <div className="space-y-2 pt-6">
            <p className="text-primary font-semibold">Falta exotismo.</p>
            <p className="text-primary font-semibold">Falta espiritualidade.</p>
            <p className="text-primary font-semibold">Falta aquele momento em que você se sente LIVRE.</p>
          </div>
          <div className="space-y-4 pt-8">
            <p>Você já imaginou soltar uma lanterna no céu no Festival Yi Peng?</p>
            <p>Você já imaginou nadar nas águas cristalinas de Koh Phi Phi?</p>
            <p>Você já imaginou visitar templos budistas milenares?</p>
            <p>Você já imaginou ser fotografada por um profissional durante toda a viagem?</p>
            <p>Você já imaginou ver o pôr do sol do Burj Khalifa?</p>
          </div>
          <div className="space-y-4 pt-8">
