        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-primary font-display italic">
              É uma transformação mágica pelos Alpes Asiáticos.
            </p>
          </div>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              Você viu milhares de lanternas subindo ao céu no Festival Yi Peng.
              Você participou do ritual simbólico de libertação.
              Você viajou em lancha rápida privada pelas ilhas paradisíacas.
              Você visitou templos milenares em Bangkok.
              Você relaxou nas praias de Krabi, Koh Phi Phi e Phuket.
              Você explorou Dubai, o contraste entre tradição e modernidade.
            </p>
            <p>
          ...
          <p className="text-lg text-foreground font-semibold">
            Você é um dos <span className="text-primary">eleitos</span> para viver a magia do Festival das Lanternas (VIP).
          </p>

          {/* Signature */}
          <div className="pt-8 border-t border-turquoise/20">
            <p className="text-primary font-display italic text-lg mb-2">
              Bem-vindo à jornada pela Tailândia e Dubai.
            </p>
            ...
            <div className="text-sm text-muted-foreground space-y-1 mt-2">
              ...
              <p>Fotógrafo Pedro registrando cada momento mágico</p>
