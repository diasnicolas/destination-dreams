...
const faqs = [
  { question: "Preciso de visto para a Tailândia?", answer: "Não precisa de visto para a Tailândia! Brasileiros podem entrar com passaporte válido por até 90 dias. Muito fácil!" },
  ...
  { question: "O fotógrafo Pedro vai durante toda a viagem?", answer: "Sim! O fotógrafo profissional Pedro acompanha o grupo durante toda a viagem, registrando os melhores momentos. Você terá fotos incríveis para guardar para sempre!" },
