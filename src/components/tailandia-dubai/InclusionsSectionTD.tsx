...
const included = ["Voos internacionais pela Emirates", "Hospedagens em hotéis/resorts 4-5 estrelas", "Resorts à beira-mar em Krabi e Phuket", "Todos os transfers privados", "Fotógrafo profissional Pedro", "Passeio de speedboat privado (Koh Phi Phi/Maya Bay)", "Festival Yi Peng (lanternas)", "Visita ao santuário de elefantes", "Passeios inclusos em Bangkok", "3 noites em Dubai com passeios", "Guias locais especializados", "Acompanhamento desde o Brasil (24/7)", "Seguro viagem completo", "App exclusivo com detalhes da viagem", "Grupo no WhatsApp"];
const notIncluded = ["Refeições não mencionadas", "Bebidas alcoólicas", "Atividades opcionais", "Gorjetas (opcional)", "Despesas pessoais"];

export const InclusionsSectionTD = () => {
  return (
