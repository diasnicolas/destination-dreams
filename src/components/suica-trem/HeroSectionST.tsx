...
const highlights = [
  {
    icon: Calendar,
    title: "14 dias de transformação",
    description: "15 a 28 de Setembro de 2026",
  },
  {
    icon: User,
    title: "Guia brasileira",
    description: "14 anos vivendo na Suíça",
  },
  {
    icon: Globe,
    title: "5 cidades icônicas",
    description: "Lucerna → Interlaken → Zermatt → St. Moritz → Zurique",
  },
  {
    icon: Sparkles,
    title: "Trens lendários",
    description: "Glacier Express, Gornergrat, Jungfraujoch",
  },
];

export const HeroSectionST = () => {
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-body tracking-wide text-primary">
              15 de Setembro de 2026 • 14 dias de transformação
            </span>
          </motion.div>
          ...
          >
            <span className="text-foreground">Você Está Pronto Para Viajar</span>
            <br />
            <span className="text-gradient-gold">Nos Trens Mais Lindos Do Mundo?</span>
          </motion.h1>
          ...
          >
            Uma jornada de 14 dias pelos Alpes Suíços que vai transformar a forma como você vê a natureza
          </motion.p>
