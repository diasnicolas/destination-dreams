...
const included = [
  "Voos internacionais (Brasil > Suíça > Brasil)",
  "Swiss International Air Lines (companhia de qualidade)",
  "Hospedagens nos melhores hotéis 4-5 estrelas",
  "Todos os transfers privados (inclusos)",
  "Todos os trens (Monte Pilatus, Jungfraujoch, Glacier Express, Gornergrat)",
  ...
  "Acompanhamento desde o Brasil (24/7)",
...
export const InclusionsSectionST = () => {
  return (
