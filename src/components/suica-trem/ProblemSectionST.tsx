  ...
  return (
    <section className="py-20 md:py-32 w-full bg-gradient-to-b from-background via-muted/30 to-background" id="problem">
      <div className="container px-4 md:px-8 lg:px-12">
        ...
        >
          <p>Você vive a vida.</p>
          <p>Você segue o ritmo do dia a dia.</p>
          ...
          <div className="space-y-2 pt-6">
            ...
            <p className="text-primary font-semibold">Falta viver experiências que realmente importam.</p>
          </div>

          <div className="space-y-4 pt-8">
            <p>Você já imaginou viajar em um trem que atravessa os Alpes?</p>
            <p>Você já imaginou ver o Topo da Europa (Jungfraujoch) de um trem panorâmico?</p>
            <p>Você já imaginou estar em Zermatt, com o Matterhorn ao fundo?</p>
            <p>Você já imaginou viajar no Glacier Express, o trem mais lendário do mundo?</p>
            <p>Você já imaginou dormir em hotéis 4-5 estrelas nos Alpes?</p>
          </div>
